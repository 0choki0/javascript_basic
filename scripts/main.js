...
console.log(stringVar, numVar, boolVar, arrayVar, objectVar)
...
myImage.addEventListener('click', function(){
    ...
    if (src === 'images/firefox-icon.png') {
        myImage.setAttribute('src', 'images/초키그림(흰배경).png')
    } else {
...
liElements.forEach(function(li){
    li.addEventListener('click', function(e){
        ...
        } else if (e.target.textContent === 'builders') {
